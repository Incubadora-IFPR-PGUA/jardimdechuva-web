...
const FORM_EMPTY = { nome: "", email: "", senha: "", confirmacaoSenha: "" };
...
const UsuariosPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editando) {
        await api.put(`/usuarios/${editando.idUsuario || editando.id}`, payload);
  ...
  const confirmarDelete = async () => {
    if (!deletando) return;
    try {
      await api.delete(`/usuarios/${deletando.idUsuario || deletando.id}`);
